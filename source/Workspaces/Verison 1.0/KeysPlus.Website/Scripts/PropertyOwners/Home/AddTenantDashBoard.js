...
function PropertyTenants(data, propData) {
    ...
    self.TenantInProperty = ko.observable(false);
    self.SupplierOrOwner = ko.observable(false);
    ...
    self.TenantEmail = ko.observable().extend({
        ...
        existingEmail: self.TenantInProperty,
        SupplierOrOwner: self.SupplierOrOwner
    });
    ...
    self.gotoBasic = function () {
        ...
        $('#liabilities').removeClass("active");
    }
