...
namespace KeysPlus.Service.Models
{
    ...
    public class RentalPaymentViewModel
    {
        ...
        public string FrequencyName { get; set; }
        public int FrequencyType { get; set; }//changed to int from string
        public bool ToBeDeleted { get; set; }
    }
    ...
    public class PropertyMyOnboardModel
    {
        ...
        public List<RentalPaymentViewModel> RentalPayments { get; set; }
    ...
    public class RequestForPropertyModel
    {
        public Address Address { get; set; }
        public IPagedList<TenantJobRequestModel> Requests { get; set; }
    }

    public class PODashBoardModel
    {
        public PropDashboardModel PropDashboardData { get; set; }
        public RentalDashboardModel RentalDashboardData { get; set; }
        public MaintenanceDashboardModel MaintenanceDashboardData { get; set; }
        public TenantDashboardModel TenantDashboardData { get; set; }
    ...
    public class RentalDashboardModel
    {
    ...
    public class MaintenanceDashboardModel
    {
        public int NewItems { get; set; }
