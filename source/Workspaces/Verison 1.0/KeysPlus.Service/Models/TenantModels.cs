...
namespace KeysPlus.Service.Models
{
    public class RegisterToBeTenantModel
    {
        ...
        [RegularExpression("^[a-z A-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,30}$",
    ...
    {
        public List<MyRentalsModel> TenantRentalDashboardData { get; set; }
